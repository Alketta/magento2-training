...
class Index extends AbstractAction {
    ...
    protected function getSearchCriteria()
    {
        ...
        // retire tous les tags
        $searchName = strip_tags($searchName);
        // interdit les caractères permmettant les injections sql
        $searchName = preg_replace('/[\'"%]/', '', $searchName);
        // retire les espace avant le searchName
        ...
        if (!in_array($sortOrder, $availableSort)) {
            // mise en place par default de l'ordre croissant
